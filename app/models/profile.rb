...
validates :personal_info,presence: true,length: {maximum:3000}
validates :qualification,presence: true,length: {maximum:400}
validates :profession,presence: true,length: {maximum:400}

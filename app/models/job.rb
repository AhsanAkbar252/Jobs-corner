...
validates :employer_email, presence: true,length: {maximum: 40}, format: {with: VALID_EMAIL_REGEX }
...
validates :job_address,presence: true,length: {maximum:100}
validates :job_city,presence: true,length: {maximum:20}
validates :job_country,presence: true,length: {maximum:20}
